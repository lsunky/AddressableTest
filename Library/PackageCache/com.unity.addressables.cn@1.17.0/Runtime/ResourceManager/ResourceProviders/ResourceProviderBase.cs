...
namespace UnityEngine.ResourceManagement.ResourceProviders
{
    ...
    /// </summary>
    [Serializable]
    internal class ProviderLoadOptions
    {
        [SerializeField] FailureSettings m_FailureSettings = FailureSettings.DefaultFail;

        /// <summary>
        /// Failure options for provider load requests
        /// </summary>
        internal FailureSettings FailureSettings
        {
            get { return m_FailureSettings; }
            set { m_FailureSettings = value; }
        }
    }
}
